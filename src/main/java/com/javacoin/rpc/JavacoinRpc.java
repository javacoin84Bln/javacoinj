...
public class JavacoinRpc {
	...
	public JavacoinRpc(String username, String password, String host, int port) throws InvalidCredentialsException {
		try {
	...
	private JsonObject callRpcMethod(RpcMethods callMethod, Object... params) throws ApiCallRpcException {
		try {
			...
			exceptionChecker.checkForError(jsonObj, callMethod);
